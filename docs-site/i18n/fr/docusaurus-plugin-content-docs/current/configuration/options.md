...
| `RAILS_PORT`                          | Port sur lequel l'application s'exécute                                                                                                                         | `3000` _lorsque `RAILS_ENV` est `development`_ |
...
| `RAILS_STORAGE_SERVICE`               | Définir le service ActiveStorage. Pour l'environnement de production uniquement.                                                                                | `local`                                        |
| `RAILS_STORAGE_URLS_EXPIRE_IN`        | Définir l'expiration de l'URL du service ActiveStorage (en minutes). Pour l'environnement de production uniquement.                                             | `30`                                           |
