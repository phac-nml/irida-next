...
Ouvrez les deux dépôts dans un éditeur de code (VS Code, Cursor, etc.) avec `irida-next-pathogen.code-workspace` (multi-root) pour avoir la documentation Lookbook et le code de la gem à côté de l’application hôte.
