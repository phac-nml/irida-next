...
L'état actuel de toute exécution de flux de travail est affiché sur la [page de liste](../analysis/working-with-workflow-executions.md) des exécutions de flux de travail.
