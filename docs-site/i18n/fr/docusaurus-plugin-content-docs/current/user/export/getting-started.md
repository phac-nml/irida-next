...
Les exportations permettent aux utilisateurs de télécharger leurs données depuis IRIDA Next en un seul clic. Suivez ces [étapes](../export/working-with-exports.md) pour apprendre à travailler avec les exportations.
