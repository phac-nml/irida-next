...
1. Navigate to the [project](../project/projects/manage-projects.md#view-projects-you-have-access-to) containing the workflow executions
...
1. Follow the steps to view either the [user](../analysis/working-with-workflow-executions.md#view-user-workflow-executions) or [automated](../analysis/working-with-workflow-executions.md#view-automated-workflow-executions) workflow executions listing page
...
1. Navigate to the [project](../project/projects/manage-projects.md#view-projects-you-have-access-to) or [group](../organization/groups/groups-manage.md#view-groups) that contains the samples you'd like to analyse
...
1. Navigate to the [project](../project/projects/manage-projects.md#view-projects-you-have-access-to) which you'd like to set up automated workflow executions
