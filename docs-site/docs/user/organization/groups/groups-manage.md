...
3. Enter a name for the group in **Group name**. For a list of words that cannot be used as group names, see [reserved names](../../project/projects/reserved-names.md).
4. Enter a path for the group in **Group URL**, which is used for the [namespace](../namespaces.md).
