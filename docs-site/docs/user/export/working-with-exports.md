...
1. Follow the [steps](../export/working-with-exports.md#view-exports) to navigate to the exports page.
...
1. Navigate to the [project](../project/projects/manage-projects.md#view-projects-you-have-access-to) or [group](../organization/groups/groups-manage.md#view-groups) that contains the samples you would like to export.
...
1. [Navigate](../analysis/working-with-workflow-executions.md#view-user-workflow-executions) to the workflow executions page.
...
1. Navigate to the [project](../project/projects/manage-projects.md#view-projects-you-have-access-to) containing the workflow execution.
