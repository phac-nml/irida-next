...
Live by _smaller iterations_. Please keep the amount of changes in a single PR **as small as possible**. If you want to contribute a large feature, think very carefully about what the minimum viable change is. Can you split the functionality into two smaller PRs? Can you submit only the backend/API code? Can you start with a very simple UI? Can you do just a part of the refactor?
...
If a regression occurs, we prefer you revert the change. Your contribution is _incomplete_ until you have made sure that it meets all these requirements.
...
1. The PR must include _Before_ and _After_ screenshots if UI changes are made.
...
1. The [PR acceptance checklist](./code_review.md#acceptance-checklist) has been checked as confirmed in the PR.
...
- [Having your pull request reviewed](./code_review.md#having-your-pull-request-reviewed)
