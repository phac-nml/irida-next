...
class FlowbiteButtonPreview < ViewComponent::Preview
  ...
  def playground(scheme: :default, size: :medium, disabled: false, block: false)
    render Flowbite::Button.new(scheme:, size:, disabled:, block:, test_selector: 'playground') do
      'Button'
    end
  end
  ...
  def default(disabled: false)
    render Flowbite::Button.new(disabled:, test_selector: 'default') do
      'Button'
    end
  end
  ...
  def primary(disabled: false, block: false)
    render Flowbite::Button.new(scheme: :primary, disabled:, block:, test_selector: 'primary') do
      'Button'
    end
  end
  ...
  def danger(disabled: false, block: false)
    render Flowbite::Button.new(scheme: :danger, disabled:, block:, test_selector: 'danger') do
      'Button'
    end
  end
  ...
  def full_width
    render Flowbite::Button.new(block: true, test_selector: 'full-width') do
      'Button'
    end
  end
  ...
  def link_as_a_button(scheme: :default, href: '#', disabled: false)
    render Flowbite::Button.new(scheme:, href:, tag: :a, disabled:, test_selector: 'link-as-a-button') do
      'Button'
    end
  end
