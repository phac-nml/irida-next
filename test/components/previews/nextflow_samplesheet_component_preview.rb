...
class NextflowSamplesheetComponentPreview < ViewComponent::Preview
  ...
  def default_v1(schema_file: 'nextflow_schema.json', sample_ids: [Sample.first.id, Sample.second.id])
  ...
  def with_reference_files_v1(schema_file: 'nextflow_schema.json', sample_ids: [Sample.first.id, Sample.second.id])
    samples = Sample.where(id: sample_ids)
    entry = {
      name: 'phac-nml/iridanextexample',
      description: 'IRIDA Next Example Pipeline',
  ...
  def with_metadata_v1(schema_file: 'nextflow_schema.json', sample_ids: [Sample.first.id, Sample.second.id])
    samples = Sample.where(id: sample_ids)
    entry = {
      name: 'phac-nml/iridanextexample',
      description: 'IRIDA Next Example Pipeline',
  ...
  def with_samplesheet_overrides_v1(sample_ids: [Sample.first.id, Sample.second.id]) # rubocop:disable Metrics/MethodLength
    samples = Sample.where(id: sample_ids)
    entry = {
  ...
  def with_samplesheet_overrides_v2 # rubocop:disable Metrics/MethodLength
    Flipper.enable(:deferred_samplesheet)
    entry = {
      url: 'https://github.com/phac-nml/fastmatchirida',
      name: 'PNC Fast Match',
