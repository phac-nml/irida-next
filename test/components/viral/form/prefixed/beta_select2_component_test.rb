...
module Viral
  module Form
    module Prefixed
      class BetaSelect2ComponentTest < ApplicationSystemTestCase
        test 'default' do
          visit '/rails/view_components/viral_form_prefixed_beta_select2_component/default'
          assert_selector 'input[type="hidden"][name="user"]', visible: :hidden, count: 1

          find('input.select2-input[type="text"]').click
          assert_selector 'div[data-viral--beta-select2-target="menu"]', visible: :visible
          assert_selector 'ul[data-viral--beta-select2-target="scroller"] li', count: 50
          ...
          assert_selector 'div[data-viral--beta-select2-target="menu"]', visible: :visible
          find('ul[data-viral--beta-select2-target="scroller"] > li').click
