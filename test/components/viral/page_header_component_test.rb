...
class PageHeaderComponentTest < ApplicationSystemTestCase
  test 'renders header' do
    ...
    assert_selector 'h1[id^="page-title-"]', text: 'Page header with Icons'
    assert_selector 'span[id^="page-subtitle-"]', text: 'This is a page header'
  ...
  test 'renders header with buttons' do
    ...
    assert_selector 'h1[id^="page-title-"]', text: 'Page header with buttons'
    assert_selector 'span[id^="page-subtitle-"]', text: 'This is a page header'
