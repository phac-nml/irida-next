...
module ComboboxDatepicker
  module V1
    class ComponentTest < ApplicationSystemTestCase
      def test_default_datepicker # rubocop:disable Metrics/AbcSize, Metrics/MethodLength, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
        ...
        Timecop.travel(test_date) do
          ...
          # verify May is selected and only 8 months exist (Jan-Apr options are not appended to to minDate)
          assert_selector 'select option', count: 8
          assert_selector 'select', text: 'May'
      ...
      def test_open_datepicker_by_clicking_input
        ...
        Timecop.travel(test_date) do
          ...
          assert_text 'ngpaewngpegaw'
        end
      end

      def test_space_and_enter_on_datepicker
        test_date = DateTime.new(2026, 5, 7, 0, 0, 0, '-06:00')
        Timecop.travel(test_date) do
          visit('/rails/view_components/combobox_datepicker_component/default')
      ...
      def test_shift_page_up_and_down
        test_date = DateTime.new(2026, 5, 7, 0, 0, 0, '-06:00')
        Timecop.travel(test_date) do
          visit('/rails/view_components/combobox_datepicker_component/default')
      ...
      def test_page_up_and_down_on_feb_leap_year
        test_date = DateTime.new(2028, 2, 28, 0, 0, 0, '-06:00')
        Timecop.travel(test_date) do
          # visit('/rails/view_components/combobox_datepicker_component/default')
          ...
          # # Feb 29 is focused upon opening
