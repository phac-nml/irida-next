      ...
      def test_open_datepicker_by_clicking_input
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_no_selector 'table tbody tr:nth-child(2) td:nth-child(6)', text: '8', focused: true
      ...
      def test_space_and_enter_on_datepicker # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_selector 'td.bg-primary-700[aria-selected="true"]', text: '8'
            ...
            find('button[data-combobox-datepicker--v1--input-target="inputArrow"]').click
            assert_no_selector 'td.bg-primary-700[aria-selected="true"]', text: '8'
            # May 8th is focused upon opening
            assert_selector 'td', text: '9', focused: true
            assert_selector 'td.bg-primary-700[aria-selected="true"]', text: '9'
      ...
      def test_home_and_end_with_min_date # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_field 'month-select', with: I18n.t('components.datepicker.months.may')
            assert_field 'year-select', with: '2026'
            assert_selector 'table tbody tr:nth-child(2) td:nth-child(6)', text: '8', focused: true

            # Focus May 9th (Sat)
            find('#test_id-calendar').send_keys(:end)
            assert_selector 'table tbody tr:nth-child(2) td:last-child', text: '9', focused: true
            ...
            assert_selector 'table tbody tr:nth-child(3) td:nth-child(6)', text: '15', focused: true

            # Focus May 16th (Sat)
            find('#test_id-calendar').send_keys(:end)
            assert_selector 'table tbody tr:nth-child(3) td:last-child', text: '16', focused: true

            # Focus May 10th (Sun)
            find('#test_id-calendar').send_keys(:home)
            assert_selector 'table tbody tr:nth-child(3) td:first-child', text: '10', focused: true
          end
        end
      end
      ...
      def test_page_up_and_down # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_field 'year-select', with: '2026'
            assert_selector 'table tbody tr:nth-child(2) td:nth-child(2)', text: '8', focused: true
            ...
            assert_selector 'table tbody tr:last-child td:first-child', text: '31', focused: true

            # page_down into June changes focus to June 30th (rather than 31st which doesn't exist)
            find('#test_id-calendar').send_keys(:page_down)
            assert_field 'month-select', with: I18n.t('components.datepicker.months.june')
            assert_field 'year-select', with: '2026'
            assert_selector 'table tbody tr:last-child td:nth-child(3)', text: '30', focused: true
            ...
            assert_field 'year-select', with: '2026'
            assert_selector 'table tbody tr:last-child td:nth-child(6)', text: '31', focused: true
      ...
      def test_shift_page_up_and_down # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_field 'month-select', with: I18n.t('components.datepicker.months.may')
            assert_field 'year-select', with: '2027'
            assert_selector 'table tbody tr:nth-child(2) td:last-child', text: '8', focused: true
      ...
      def test_shift_page_up_and_down_on_feb_leap_year # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_field 'year-select', with: '2027'
            assert_selector 'table tbody tr:nth-child(5) td:nth-child(6)', text: '29', focused: true
            ...
            assert_selector 'table tbody tr:last-child td:nth-child(3)', text: '29', focused: true

            # shift+page_up to verify we land on Feb 28, 2027 (rather than non-existent Feb 29)
            find('#test_id-calendar').send_keys(%i[shift page_up])
            assert_field 'month-select', with: I18n.t('components.datepicker.months.february')
            assert_field 'year-select', with: '2027'
            assert_selector 'table tbody tr:last-child td:first-child', text: '28', focused: true
            ...
            assert_selector 'table tbody tr:last-child td:nth-child(4)', text: '28', focused: true
          end
        end
      end
      ...
      def test_page_up_into_disabled_date # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_field 'month-select', with: I18n.t('components.datepicker.months.june')
            assert_field 'year-select', with: '2026'
            assert_selector 'table tbody tr:first-child td:nth-child(2)', text: '1', focused: true
      ...
      def test_shift_page_up_into_disabled_date
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            find('#test_id-calendar').send_keys(%i[shift page_down], :up)
            assert_selector 'table tbody tr:first-child td:last-child', text: '1', focused: true
      ...
      def test_datepicker_with_already_selected_date
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_selector 'td.bg-primary-700[aria-selected="true"]', text: '14'
          end
        end
      end
      ...
      def test_directly_entering_date # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        Timecop.travel(test_date) do
          Capybara.current_session.driver.with_playwright_page do |page|
            ...
            assert_selector 'table tbody tr:nth-child(2) td.bg-primary-700[aria-selected="true"]', text: '7',
                                                                                                   focused: true
            assert_field 'month-select', with: I18n.t('components.datepicker.months.july')
            assert_field 'year-select', with: '2026'
          end
