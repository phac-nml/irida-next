...
module Flowbite
  class ButtonTest < ViewComponent::TestCase
    test 'default button' do
      render_inline(Flowbite::Button.new(test_selector: 'playground')) { 'Button' }
    ...
    test 'default button with disabled' do
      render_inline(Flowbite::Button.new(test_selector: 'playground', disabled: true)) { 'Button' }
    ...
    test 'button with leading visual icon' do
      component = Flowbite::Button.new(test_selector: 'playground').tap do |c|
    ...
    test 'button with custom class' do
      render_inline(Flowbite::Button.new(test_selector: 'playground', class: 'custom-class')) { 'Button' }
    ...
    test 'button with aria attributes' do
      render_inline(Flowbite::Button.new(test_selector: 'playground', aria: { label: 'Custom Label', expanded: true })) { 'Button' }
    ...
    test 'button as a link' do
      render_inline(Flowbite::Button.new(test_selector: 'playground', tag: :a, href: '/example')) { 'Link Button' }
