  ...
  module Bots
    class PersonalAccessTokensControllerTest < ActionDispatch::IntegrationTest
      ...
      test 'should successfully get bot personal access tokens listing' do
        ...
        get namespace_project_bot_personal_access_tokens_path(namespace, project, id: namespace_bot.user.id,
                                                                                  format: :turbo_stream)
      ...
      test 'should successfully get the new bot personal access token modal' do
        ...
        get new_namespace_project_bot_personal_access_token_path(namespace, project, id: namespace_bot.user.id,
                                                                                     format: :turbo_stream)
      ...
      test 'should successfully create a new bot personal access token' do
        ...
        post namespace_project_bot_personal_access_tokens_path(namespace, project, id: namespace_bot.user.id,
                                                                                   format: :turbo_stream),
