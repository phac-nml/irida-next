...
module Projects
  class SamplesControllerTest < ActionDispatch::IntegrationTest
    ...
    test 'should create sample' do
      ...
      assert_redirected_to namespace_project_sample_url(id: Sample.last.id, tab: 'files')
    end
    ...
    test 'should update sample in which the user is a member in a parent group with a role >= Maintainer' do
      patch namespace_project_sample_url(@namespace, @project, @sample1),
            ...
            as: :turbo_stream
      assert_redirected_to namespace_project_sample_url(@namespace, @project, @sample1, tab: 'files')
    end
    ...
    test 'should update sample in which the the project is in the user\'s namespace' do
      ...
      patch namespace_project_sample_url(namespace, project, sample),
            ...
            as: :turbo_stream
      assert_redirected_to namespace_project_sample_url(namespace, project, sample, tab: 'files')
    end
