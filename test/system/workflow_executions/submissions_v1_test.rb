...
module WorkflowExecutions
  ...
  class SubmissionsV1Test < ApplicationSystemTestCase
    ...
    test 'required attachments samplesheet validation' do
      ...
      assert_selector 'div[data-nextflow--v1--samplesheet-target="error"]'
    ...
    test 'samplesheet pagination' do
      ...
      assert_selector 'button[data-action="click->nextflow--v1--samplesheet#previousPage"][disabled]',
                      text: I18n.t('components.nextflow.samplesheet_component.previous')
      assert_selector 'select[data-action="change->nextflow--v1--samplesheet#pageSelected"]', text: '1'
      within('select[data-action="change->nextflow--v1--samplesheet#pageSelected"]') do
      ...
      assert_selector 'button[data-action="click->nextflow--v1--samplesheet#nextPage"]',
      ...
      assert_selector 'button[data-action="click->nextflow--v1--samplesheet#previousPage"]',
                      text: I18n.t('components.nextflow.samplesheet_component.previous')
      assert_no_selector 'button[data-action="click->nextflow--v1--samplesheet#previousPage"][disabled]',
                         text: I18n.t('components.nextflow.samplesheet_component.previous')
      # page dropdown selection updated
      assert_selector 'select[data-action="change->nextflow--v1--samplesheet#pageSelected"]', text: '2'
      # navigate to page 3 of 4
      click_button I18n.t('components.nextflow.samplesheet_component.next')

      assert_selector 'select[data-action="change->nextflow--v1--samplesheet#pageSelected"]', text: '3'
      ...
      assert_selector 'select[data-action="change->nextflow--v1--samplesheet#pageSelected"]', text: '4'
      # verify next button is disabled on last page
      assert_selector 'button[data-action="click->nextflow--v1--samplesheet#nextPage"][disabled]',
                      text: I18n.t('components.nextflow.samplesheet_component.next')
    ...
    test 'pagination does not render if only one page of samples' do
      ...
      # data-nextflow--v1--samplesheet-target="paginationContainer"
      assert_selector 'div[data-nextflow--v1--samplesheet-target="paginationContainer"]'
      assert_no_selector 'button[data-action="click->nextflow--v1--samplesheet#previousPage"][disabled]',
                         text: I18n.t('components.nextflow.samplesheet_component.previous')
      assert_no_selector 'select[data-action="change->nextflow--v1--samplesheet#pageSelected"]', text: '1'

      assert_no_selector 'button[data-action="click->nextflow--v1--samplesheet#nextPage"]',
                         text: I18n.t('components.nextflow.samplesheet_component.next')
    ...
    test 'samplesheet filtering empty state' do
      ...
      # verify empty state
      assert_selector 'div[data-nextflow--v1--samplesheet-target="emptyState"]'
    ...
    test 'samplesheet filter search and clear buttons' do
      ...
      assert_selector 'button[data-nextflow--v1--samplesheet-target="filterSearchButton"]'
      assert_no_selector 'button[data-nextflow--v1--samplesheet-target="filterClearButton"]'
      # enter filter and click search button
      find('input#samplesheet-filter').fill_in with: 'INXT_SAM_AAAAAAAAAC'
      find('button[data-nextflow--v1--samplesheet-target="filterSearchButton"]').click
      ...
      assert_no_selector 'button[data-nextflow--v1--samplesheet-target="filterSearchButton"]'
      assert_selector 'button[data-nextflow--v1--samplesheet-target="filterClearButton"]'

      # click clear button to remove filter
      find('button[data-nextflow--v1--samplesheet-target="filterClearButton"]').click
