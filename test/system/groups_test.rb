...
class GroupsTest < ApplicationSystemTestCase
  ...
  test 'visiting the show' do
    ...
    assert_selector 'a[aria-current="page"]', text: I18n.t(:'groups.show.tabs.subgroups_and_projects')
    ...
    assert_selector 'a[aria-current="page"]', text: I18n.t(:'groups.show.tabs.shared_namespaces')
    assert_selector 'div.treegrid-row', count: 1
  end
