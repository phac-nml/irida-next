...
module Dashboard
  class GroupsTest < ApplicationSystemTestCase
    ...
    test 'can sort the list of groups by name descending' do
      ...
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.created_at_desc')
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.name_desc')
      sleep 1
      assert_text I18n.t(:'dashboard.groups.sort_links.sorting.name_desc')
    ...
    test 'can sort the list of groups by name ascending' do
      ...
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.created_at_desc')
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.name_asc')
      sleep 1
      assert_text I18n.t(:'dashboard.groups.sort_links.sorting.name_asc')
    ...
    test 'can sort the list of groups by updated at desc' do
      ...
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.created_at_desc')
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.updated_at_desc')
      sleep 1
      assert_text I18n.t(:'dashboard.groups.sort_links.sorting.updated_at_desc')
    ...
    test 'can sort the list of groups by updated at asc' do
      ...
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.created_at_desc')
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.updated_at_asc')
      sleep 1
      assert_text I18n.t(:'dashboard.groups.sort_links.sorting.updated_at_asc')
    ...
    test 'can sort the list of groups by created_at asc' do
      ...
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.created_at_desc')
      click_on I18n.t(:'dashboard.groups.sort_links.sorting.created_at_asc')
      sleep 1
      assert_text I18n.t(:'dashboard.groups.sort_links.sorting.created_at_asc')
