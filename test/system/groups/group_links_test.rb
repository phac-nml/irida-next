...
module Groups
  class GroupLinksTest < ApplicationSystemTestCase
    ...
    test 'can create a group to group link' do
      ...
      click_button I18n.t(:'groups.members.index.invite_group')
      ...
      within('div[data-controller-connected="true"] dialog') do
        ...
        find('input[data-select2--v1-target="input"]').click
    ...
    test 'cannot update namespace group link which may have been deleted in another tab' do
      ...
      within 'dialog' do
        assert_selector 'h1', text: I18n.t(:'groups.group_links.edit.title')
