...
module Groups
  class GroupLinksTest < ApplicationSystemTestCase
    ...
    test 'can sort by column' do
      ...
      assert_selector 'table thead th[aria-sort="descending"]', text: 'Group'.upcase
      within('tbody') do
      ...
      wait_for_network_idle
      assert_selector 'table thead th[aria-sort="ascending"]', text: 'Access Level'.upcase
      within('tbody') do
        assert_selector 'tr:first-child td:first-child', text: @group_link5.group.name
        assert_selector 'tr:first-child td:nth-child(4)',
                        text: Member::AccessLevel.human_access(@group_link5.group_access_level)
      ...
      wait_for_network_idle
      assert_selector 'table thead th[aria-sort="ascending"]', text: 'Expiration'.upcase
      within('tbody') do
        assert_selector 'tr:first-child td:first-child', text: @group_link5.group.name
