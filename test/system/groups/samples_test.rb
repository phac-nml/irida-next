...
module Groups
  class SamplesTest < ApplicationSystemTestCase
    ...
    test 'can sort the list of samples' do
      ...
      click_on 'Created'
      assert_selector 'table thead th:nth-child(4) [data-test-selector="sort_icon_desc"]'
      within('table tbody') do
        assert_selector 'tr:first-child th', text: @sample1.puid
        assert_selector 'tr:first-child td:nth-child(2)', text: @sample1.name
        assert_selector 'tr:nth-child(2) th', text: @sample2.puid
    ...
    test 'can filter by name and then sort the list of samples' do
      ...
      assert_no_selector 'table thead th:nth-child(2) [data-test-selector="sort_icon_asc"]'
      click_on I18n.t(:'samples.table_component.name')
      assert_selector 'table thead th:nth-child(2) [data-test-selector="sort_icon_asc"]'
    ...
    test 'can sort samples by metadata column' do
      ...
      assert_selector 'table thead th:nth-child(7) [data-test-selector="sort_icon_asc"]'
      ...
      assert_selector 'table thead th:nth-child(8) [data-test-selector="sort_icon_asc"]'
      ...
      assert_selector 'table thead th:nth-child(5) [data-test-selector="sort_icon_desc"]'
      within('tbody') do
        assert_selector 'tr:first-child th', text: @sample1.puid
        assert_selector 'tr:first-child td:nth-child(2)', text: @sample1.name
        assert_selector 'tr:nth-child(2) th', text: @sample2.puid
