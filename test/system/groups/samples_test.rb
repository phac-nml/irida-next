...
module Groups
  class SamplesTest < ApplicationSystemTestCase
    ...
    test 'can sort the list of samples' do
      ...
      within first('table tbody#group-samples-table-body') do
        assert_selector 'tr:nth-child(3) td:nth-child(2)', text: @sample28.puid
        assert_selector 'tr:nth-child(3) td:nth-child(3)', text: @sample28.name
        assert_selector 'tr:nth-child(4) td:nth-child(2)', text: @sample25.puid
        assert_selector 'tr:nth-child(4) td:nth-child(3)', text: @sample25.name
      end
    ...
    test 'can filter by name and then sort the list of samples' do
      ...
      within first('table tbody') do
        assert_selector 'tr:first-child td:nth-child(2)', text: @sample1.puid
        assert_selector 'tr:first-child td:nth-child(3)', text: @sample1.name
        assert_selector 'tr:nth-child(2) td:nth-child(2)', text: @sample25.puid
        assert_selector 'tr:nth-child(2) td:nth-child(3)', text: @sample25.name
      end
    end
    ...
    test 'can sort samples by metadata column' do
      ...
      within first('tbody') do
        assert_selector 'tr:first-child td:nth-child(2)', text: @sample30.puid
        assert_selector 'tr:first-child td:nth-child(3)', text: @sample30.name
        assert_selector 'tr:nth-child(2) td:nth-child(2)', text: @sample2.puid
        assert_selector 'tr:nth-child(2) td:nth-child(3)', text: @sample2.name
      end
      ...
      assert_selector 'table thead th:nth-child(9) svg.icon-arrow_up'
      within first('tbody') do
        assert_selector 'tr:first-child td:nth-child(2)', text: @sample30.puid
        assert_selector 'tr:first-child td:nth-child(3)', text: @sample30.name
        assert_selector 'tr:nth-child(2) td:nth-child(2)', text: @sample2.puid
