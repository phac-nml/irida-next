...
module Groups
  class WorkflowExecutionsAdvancedSearchTest < ApplicationSystemTestCase
    setup do
      ...
      @workflow_execution1 = workflow_executions(:workflow_execution_group_shared1)
    ...
    test 'can open and use advanced search dialog' do
      ...
      within 'dialog[open]' do
        assert_accessible
        assert_selector 'h1', text: I18n.t('components.advanced_search_component.title', locale: @user.locale)
        ...
        within "select[name$='[field]']" do
          assert_text I18n.t('workflow_executions.table_component.id', locale: @user.locale)
          assert_text I18n.t('workflow_executions.table_component.name', locale: @user.locale)
          assert_text I18n.t('workflow_executions.table_component.state', locale: @user.locale)
          assert_text I18n.t('workflow_executions.table_component.run_id', locale: @user.locale)
          assert_text I18n.t('workflow_executions.table_component.created_at', locale: @user.locale)
          assert_text I18n.t('workflow_executions.table_component.updated_at', locale: @user.locale)
        end

        # Verify operators are available
        within "select[name$='[operator]']" do
          assert_text I18n.t('components.advanced_search_component.operation.equals', locale: @user.locale)
          assert_text I18n.t('components.advanced_search_component.operation.contains', locale: @user.locale)
          assert_text I18n.t('components.advanced_search_component.operation.in', locale: @user.locale)
        end
      end
    end
    ...
    test 'can add multiple conditions to a group' do
      ...
      within 'dialog[open]' do
        ...
        within first("fieldset[data-advanced-search-target='groupsContainer']") do
          click_button I18n.t('components.advanced_search_component.add_condition_button', locale: @user.locale)
    ...
    test 'can add multiple groups for OR logic' do
      ...
      within 'dialog[open]' do
        # Add a second group
        click_button I18n.t('components.advanced_search_component.add_group_button', locale: @user.locale)
    ...
    test 'can clear advanced search filters' do
      ...
      within 'dialog[open]' do
        ...
        click_button I18n.t('components.advanced_search_component.clear_filter_button', locale: @user.locale)
      end
    ...
    test 'can remove a group from advanced search' do
      ...
      within 'dialog[open]' do
        ...
        within all("fieldset[data-advanced-search-target='groupsContainer']")[1] do
          click_button I18n.t('components.advanced_search_component.remove_group_button', locale: @user.locale)
        end
    ...
    test 'advanced search dialog prompts for confirmation when closing with unapplied changes' do
      ...
      within 'dialog[open]' do
        ...
        text = dismiss_confirm do
          click_button I18n.t('components.dialog.close', locale: @user.locale)
        end
        assert_includes text, I18n.t('components.advanced_search_component.confirm_close_text', locale: @user.locale)
      end
