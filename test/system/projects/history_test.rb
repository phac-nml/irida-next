...
module Projects
  class HistoryTest < ApplicationSystemTestCase
    ...
    test 'can see modal with changes to project from previous version' do
      visit namespace_project_history_path(@namespace, @project)
      assert_button I18n.t(:'components.history.link_text', version: 1)
      click_button I18n.t(:'components.history.link_text', version: 1)

      assert_selector 'dialog h1', text: I18n.t(:'components.history.link_text', version: 1)
      assert_selector 'dialog p', text: I18n.t(:'projects.history.project_history_modal_description.project_created',
                                               user: 'System')
