...
module Projects
  class GroupLinksTest < ApplicationSystemTestCase
    ...
    test 'cannot access group links' do
      ...
      assert_text I18n.t(:'action_policy.policy.namespaces/project_namespace.member_listing?', name: @namespace.name)
    end
    ...
    test 'cannot add a project to group link' do
      ...
      assert_selector 'a', text: I18n.t(:'projects.members.index.invite_group'), count: 0
    end
