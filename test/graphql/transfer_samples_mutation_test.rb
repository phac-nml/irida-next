...
class TransferSamplesMutationTest < ActiveSupport::TestCase
  ...
  test 'transferSamples mutation should partially work with only some of the samples valid' do
    project1 = projects(:project1)
    project2 = projects(:project2)
  ...
  test 'transferSamples mutation should not work when sample gid is invalid, partial success' do
    project1 = projects(:project1)
    project2 = projects(:project2)
