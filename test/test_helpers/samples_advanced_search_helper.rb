...
# Shared helpers for exercising the samples advanced search at the request level.
module SamplesAdvancedSearchHelper
  # Builds the nested `q[groups_attributes]` params the samples advanced search form
  ...
  def samples_advanced_search_params(groups)
