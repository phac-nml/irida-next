...
ActiveRecord::Schema[7.2].define(version: 2025_01_08_194807) do
  ...
  add_foreign_key "metadata_templates", "namespaces"
  add_foreign_key "metadata_templates", "users", column: "created_by_id"
