...
def seed_exports # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
  ...
  export_params.each_with_index do |export_param, index|
    ...
    DataExport.create(
      ...
      export_parameters: { ids: [export_param[:sample_id]], namespace_id: export_param[:namespace_id] },
      status: 'processing',
      export_type: 'sample',
