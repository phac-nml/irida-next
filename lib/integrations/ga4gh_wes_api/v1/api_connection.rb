    ...
    module V1
      ...
      class ApiConnection
        ...
        def initialize(api_server_url = nil)
          @api_endpoint = if api_server_url.nil? && Rails.configuration.ga4gh_wes_server_endpoint.nil?
                            "http://www.example.com/#{Ga4ghWesApi::API_SERVER_ENDPOINT_PATH}#{V1::API_SERVER_ENDPOINT_VERSION}"
                          elsif api_server_url.nil? && Rails.configuration.ga4gh_wes_server_endpoint.present?
