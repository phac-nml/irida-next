...
module Flowbite
  # This file defines the BaseButton class within the Flowbite module.
  # BaseButton is a foundational component for creating buttons in the Flowbite design system.
  #
  class BaseButton < Flowbite::Component
    ...
    # @return [Flowbite::BaseComponent] The rendered button component
    def call
