...
module Resolvers
  module Metrics
    ...
    class DiskUsageResolver < BaseResolver
      ...
      def calculate_disk_usage(namespace, direct_only)
        ...
        attachments = authorized_scope(Attachment,
                                       type: :relation, as: :namespace_attachments,
                                       scope_options: { namespace_ids: ns_ids })

        blob_ids = attachments.joins(file_attachment: :blob).distinct.pluck('active_storage_blobs.id')
