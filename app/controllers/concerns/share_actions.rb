...
module ShareActions # rubocop:disable Metrics/ModuleLength
  ...
  def create # rubocop:disable Metrics/MethodLength, Metrics/AbcSize
    namespace_group_link = Namespaces::GroupShareService.new(current_user, @namespace, group_link_params).execute
  ...
  def destroy # rubocop:disable Metrics/MethodLength
    Namespaces::GroupUnshareService.new(current_user, @namespace_group_link).execute
    respond_to do |format|
      if @namespace_group_link
  ...
  def update # rubocop:disable Metrics/MethodLength
    updated = Namespaces::GroupShareUpdateService.new(current_user, @namespace_group_link, group_link_params).execute
    respond_to do |format|
      if updated
        format.turbo_stream do
          render status: :ok, locals: { namespace_group_link: @namespace_group_link,
