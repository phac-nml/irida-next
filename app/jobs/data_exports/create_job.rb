...
module DataExports
  ...
  class CreateJob < ApplicationJob
    ...
    def perform(data_export) # rubocop:disable Metrics
      ...
      Zip::File.open(new_zip.path, create: true) do |zipfile|
        sample_ids.each do |sample_id|
          ...
          sample.attachments.each do |attachment|
            ...
            current_directory = project.puid + '/' + sample.puid + '/' + attachment.id.to_s + '/' + attachment.file.filename.to_s # rubocop:disable Style
            ...
            current_directory = project.puid + '/' + sample.puid + '/' + attachment.id.to_s + '/' + paired_attachment.file.filename.to_s # rubocop:disable Style
      ...
      filename = uid + '.zip' # rubocop:disable Style
