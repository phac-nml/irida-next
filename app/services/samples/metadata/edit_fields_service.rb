...
module Samples
  module Metadata
    ...
    class EditFieldsService < BaseService
      SampleMetadataEditFieldError = Class.new(StandardError)
      ...
      rescue Samples::Metadata::EditFieldsService::SampleMetadataEditFieldError => e
      ...
      def validate_edit_fields
        ...
        raise SampleMetadataEditFieldError, I18n.t('services.samples.metadata.edit_fields.metadata_was_not_changed')
      end
      ...
      def construct_metadata_update_params
        ...
        if @key_edit.keys[0] != @key_edit.values[0]
          if validate_new_key
            raise SampleMetadataEditFieldError,
