    ...
    class TransferService < BaseGroupService # rubocop:disable Metrics/ClassLength
      ...
      def transfer(new_project, sample_ids, broadcast_target) # rubocop:disable Metrics/MethodLength, Metrics/AbcSize
        ...
        sample_ids.each.with_index(1) do |sample_id, index|
          ...
          @group.errors.add(:samples, I18n.t('services.samples.transfer.sample_exists',
      ...
      def create_activities(transferred_samples_data) # rubocop:disable Metrics/MethodLength, Metrics/AbcSize
        transferred_samples_data.each do |key, data|
          ...
          activity = old_namespace.create_activity key: 'namespaces_project_namespace.samples.transfer',
                                                   owner: current_user,
                                                   parameters:
                                                    {
          ...
          activity = new_namespace.create_activity key: 'namespaces_project_namespace.samples.transferred_from',
                                                   owner: current_user,
                                                   parameters:
                                                    {
