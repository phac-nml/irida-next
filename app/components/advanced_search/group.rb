  ...
  class Group < Component
    ...
    def deprecate_legacy_params(sample_fields, metadata_fields)
      if sample_fields.present?
        Rails.logger.warn(
          'DEPRECATION WARNING: AdvancedSearch::Group: sample_fields is deprecated, use entity_fields instead'
        )
      end
      ...
      Rails.logger.warn(
        'DEPRECATION WARNING: AdvancedSearch::Group: metadata_fields is deprecated, use jsonb_fields instead'
      )
    end
  end
end
