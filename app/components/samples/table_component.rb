  ...
  class TableComponent < Component
    ...
    def initialize(
      ...
      **system_arguments
      ...
      @sort_key, @sort_direction = search_params[:s].split
    ...
    def sort_url(field)
      ...
      if @namespace.type == 'Group'
        group_samples_url(@namespace, q: { s: sort_string })
      else
        namespace_project_samples_url(@namespace.parent, @namespace.project, q: { s: sort_string })
      end
    end
