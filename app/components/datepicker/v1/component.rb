  ...
  module V1
    ...
    class Component < ::Component
      ...
      def setup_container_attributes # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
        ...
        @system_arguments[:data][:controller] = 'datepicker--input'
        @system_arguments[:data]['datepicker--input-datepicker--calendar-outlet'] = "##{@calendar_id}"
        @system_arguments[:data]['datepicker--input-autosubmit-value'] = @autosubmit
        @system_arguments[:data]['datepicker--input-invalid-date-value'] =
          I18n.t('components.datepicker.errors.invalid_date')
        @system_arguments[:data]['datepicker--input-invalid-min-date-value'] =
          I18n.t('components.datepicker.errors.min_date_error')
        @system_arguments[:data]['datepicker--input-calendar-id-value'] = @calendar_id
        @system_arguments[:data]['datepicker--input-date-format-regex-value'] =
      ...
      def setup_calendar_attributes
        ...
        @calendar_arguments[:data][:controller] = 'datepicker--calendar'
        @calendar_arguments[:data]['datepicker--calendar-datepicker--input-outlet'] =
          "##{@container_id}"
        @calendar_arguments[:data]['datepicker--calendar-months-value'] = @months
      end
    end
  end
end
