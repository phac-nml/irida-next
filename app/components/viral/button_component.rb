...
module Viral
  class ButtonComponent < Viral::Component
    ...
    TYPE_MAPPINGS = {
      ...
      :primary => 'text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg dark:bg-primary-600 dark:hover:bg-primary-800 focus:outline-none dark:focus:ring-primary-800',
