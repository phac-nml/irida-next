...
module Viral
  ...
  class DropdownComponent < Viral::Component
    ...
    def system_arguments_for_icon
      @system_arguments[:classes] = class_names(
        'rounded-full text-sm text-gray-500 p-2.5 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700',
        @system_arguments[:classes]
      )
      @system_arguments
    end
