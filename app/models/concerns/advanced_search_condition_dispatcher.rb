...
# Shared operator dispatch for advanced search conditions.
#
# This concern expects the including class to:
# - include `AdvancedSearchConditions` (for `build_arel_node` and `condition_*` helpers)
# - provide `model_class`
#
# Override points:
...
module AdvancedSearchConditionDispatcher
